window.addEventListener('load', function () {
    ...
    updateBtn.addEventListener("click", function (event) {
        ...
        fetch(`http://localhost:3000/products/${currentEditProductId}`, {
            ...
            .then((res) => {
                ...
                const index = productArr.findIndex(p => p.id == currentEditProductId);
                if (index !== -1) {
                ...
                <div class="product-details">
                    ...
                    <div class="product-bottom-details">
                        <div>
                            ...
                            <div class="product-price"><small>$${p.price}</small></div>
                        </div>
    ...
    searchInput.addEventListener("input", function () {
        ...
        const filtered = productArr.filter(p => p.title.toLowerCase().includes(searchValue));
